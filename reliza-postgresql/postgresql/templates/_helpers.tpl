...
{{- end }}
  [ -f /opt/relizaio/postgresql/tmp/.initialized ] || [ -f /relizaio/postgresql/.initialized ]
{{- end -}}
...
{{- if .Values.tls.autoGenerated -}}
    {{- printf "/opt/relizaio/postgresql/certs/tls.crt" -}}
{{- else -}}
    {{- required "Certificate filename is required when TLS in enabled" .Values.tls.certFilename | printf "/opt/relizaio/postgresql/certs/%s" -}}
{{- end -}}
{{- end -}}
...
{{- if .Values.tls.autoGenerated -}}
    {{- printf "/opt/relizaio/postgresql/certs/tls.key" -}}
{{- else -}}
{{- required "Certificate Key filename is required when TLS in enabled" .Values.tls.certKeyFilename | printf "/opt/relizaio/postgresql/certs/%s" -}}
{{- end -}}
{{- end -}}
...
{{- if .Values.tls.autoGenerated -}}
    {{- printf "/opt/relizaio/postgresql/certs/ca.crt" -}}
{{- else -}}
    {{- printf "/opt/relizaio/postgresql/certs/%s" .Values.tls.certCAFilename -}}
{{- end -}}
{{- end -}}
...
{{- printf "/opt/relizaio/postgresql/certs/%s" .Values.tls.crlFilename -}}
{{- end -}}
{{- end -}}
